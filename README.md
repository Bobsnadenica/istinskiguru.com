...
- `index.html`: a brief mission, three tactic links, and searchable sourced investigations. Six cards appear initially; readers can show more. Every card is a normal link to a full profile page.
...
- `gallery.html`: separately labelled legacy commentary archive, not mixed into the sourced investigation list.

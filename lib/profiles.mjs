...
<html lang="bg">
  <head>
    ...
    <link rel="stylesheet" href="/styles.css${profile.reviewHtml ? "?v=20260922-topcoding" : ""}" />
    <script src="/page-effects.js" defer></script>
  ...
  <body class="profile-page${profile.reviewHtml ? " evidence-profile" : ""}">
    <div class="page-shell">
      <header class="hero article-hero profile-share-hero" id="top">
        <div class="hero-copy">
          <nav class="page-nav" aria-label="Навигация">
            <a href="${escapeHtml(catalogUrl)}">Към регистъра</a>
          </nav>
          <p class="eyebrow">Публичен Профил • Линкове • Обещания</p>
          <h1>${escapeHtml(profile.name)}</h1>
          <p class="hero-text">${escapeHtml(profile.summary || profile.description || profile.imageNote)}</p>
          <p class="context-note">
            ${profile.reviewHtml ? "Проверка по публични източници. По-долу разграничаваме наблюдаваните факти, редакционната оценка и неизвестното." : "Редакционен коментар с елементи на сатира. Присъствието в регистъра не означава установена измама или участие в Понци схема. Публичните канали по-долу не са независимо потвърждение на твърденията."} <a href="/contactus.html">Изпрати корекция или източник.</a>
          </p>
      ...
      <footer class="site-footer">
        <p>Регистър на Онлайн Гурута</p>
        <div class="site-footer-links">
          <a href="/privacy.html">Поверителност</a>
          <a href="/terms.html">Общи условия</a>
          <a href="/contactus.html">Контакти</a>
          <a href="https://www.facebook.com/profile.php?id=61594111673410" target="_blank" rel="noreferrer">Facebook</a>

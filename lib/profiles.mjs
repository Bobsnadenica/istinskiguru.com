...
async function optimiseImageAsset(sourceImagePath, targetImagePath) {
  const extension = path.extname(targetImagePath).toLowerCase();
  const sipsArgs = [];

  if (extension === ".jpg" || extension === ".jpeg") {
    sipsArgs.push("-s", "format", "jpeg", "-s", "formatOptions", optimizedJpegQuality);
  }

  sipsArgs.push("-Z", String(optimizedImageMaxDimension), sourceImagePath, "--out", targetImagePath);
                ...
                (videoPath, index) => `
                  <div class="profile-video-frame">
                    <button
                      ...
                      data-video-poster="${escapeHtml(imagePath)}"
                    ...
                    >
                      <img class="profile-video-poster" src="${escapeHtml(imagePath)}" alt="" loading="lazy" decoding="async" fetchpriority="low" />
        ...
        <article class="profile-card" id="${escapeHtml(profile.id)}" data-orientation="${escapeHtml(profile.orientation)}">
          <div class="profile-rail">
            <div class="profile-media">
              <img src="${escapeHtml(imagePath)}" alt="${escapeHtml(profile.alt)}" decoding="async" />

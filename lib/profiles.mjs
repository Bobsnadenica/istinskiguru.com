...
const siteShareCardFileName = "catalog-share.jpg";
    ...
    <div class="page-shell">
      ...
      <footer class="site-footer">
        ...
        <div class="site-footer-links">
          ...
          <a href="https://www.facebook.com/profile.php?id=61573227173786" target="_blank" rel="noreferrer">Facebook</a>
...
export async function writeSiteData(rootDir = process.cwd()) {
  ...
  await generateShareCard(
    {
      name: "Регистър на Онлайн Гурута",
      kicker: "Български бизнес гурута, курсове и ментори",
      summary:
        "Регистър на онлайн гурута, бизнес коучове и продавачи на чудеса, подредени в споделими профили.",
    },
    path.join(staticAssetsDir, "__site-share-source__.jpg"),

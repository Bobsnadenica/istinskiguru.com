...
function getProfileMetaDescription(profile) {
  return truncateText(
    [
      `Профил на ${profile.name} в каталог за публични онлайн гуру обещания и сигнали за онлайн измами.`,
  ...
  await generateShareCard(
    {
      ...
      summary:
        "Каталог на онлайн гурута, бизнес коучове и продавачи на чудеса, подредени в споделими профили.",
    },

...
function getProfileMetaDescription(profile) {
  return truncateText(
    [
      `Сатиричен профил на ${profile.name} в комедиен каталог за публични онлайн гуру обещания и scam сигнали.`,
    ...
    <div class="page-shell">
      <header class="hero article-hero profile-share-hero" id="top">
        <div class="hero-copy">
          ...
          <p class="eyebrow">Сатиричен Профил • Публични Линкове • Редакционен Прочит</p>
          <h1>${escapeHtml(profile.name)}</h1>
          <p class="hero-text">${escapeHtml(profile.summary || profile.description || profile.imageNote)}</p>
          <p class="satire-note">
            Това е комедиен и сатиричен профил върху публично съдържание. Описваме
            маркетингови сигнали и обещания, не произнасяме юридическа присъда.
          </p>
  ...
  await generateShareCard(
    {
      ...
      summary:
        "Сатиричен каталог на онлайн гурута, бизнес коучове и продавачи на чудеса, подредени в споделими профили.",
    },

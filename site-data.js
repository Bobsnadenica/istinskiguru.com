window.__GURU_PROFILES__ = [
  ...
  },
  {
    ...
    "orientation": "portrait",
    "description": "Аз съм без думи - бизнес консултант бил човека, помагал на работещи професионалисти да си докарват 2-3 хиляди лева на месец онлайн. :D",
    "kicker": "",
    "summary": "",
    "aura": "",
    "funnel": "",
  ...
  },
  {
    ...
    "orientation": "portrait",
    "description": "Гошето е радикален хомосексуалист, измамник и лъжец....ааааааа исках да кажа че е успешен бизнесмен и ще ви научи как да правите пари! Фирмата му има счетоводна печалба от 1000лв , ама вас ще ви научи как да правите милиони! Топ пич!",
  ...
  },
  {
    ...
    "orientation": "portrait",
    "description": "Тук духовният рестарт идва с усещането, че блокажите не са кой знае какъв проблем, стига да попаднеш на правилния човек, правилната сесия и правилното количество доверие към невидимото.",
    ...
    "insight": "Когато решението е едновременно нежно, дълбоко и трудно за измерване, то много лесно започва да изглежда като услуга от по-висш порядък.",
    "channels": [
      "Уебсайт",
      "Facebook"
    ],

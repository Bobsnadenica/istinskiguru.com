window.__GURU_PROFILES__ = [
  {
    ...
    "description": "Публичен образ, подреден така, че още от първия поглед да внуши скорост, самочувствие и усещане, че големият пробив вече е започнал.",
    "kicker": "Тва е Sid от Ice Age ако беше още по-retarded",
    "summary": "Алекс Чикийката ви учи на айсберг модела. Алекс е млада и успяла жена, завършила 12-ти клас едвам едвам, защото това е пълен скам и вие всички сте трохари които му пречат да прави пари! Ама ако искате - запишете се за някое курсче и той ще ви научи как да правите пари.",
